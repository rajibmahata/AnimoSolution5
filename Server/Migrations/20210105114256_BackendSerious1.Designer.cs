...
namespace AnimoWeb.Server.Migrations
{
    ...
    [Migration("20210105114256_BackendSerious1")]
    partial class BackendSerious1
    {
            ...
            modelBuilder.Entity("Model.Shared.GlobalConfig", b =>
                {
                    ...
                    b.Property<string>("FirmaPhone1")
                        .HasColumnType("TEXT");

                    b.Property<string>("FirmaPhone2")
                        .HasColumnType("TEXT");
